    ...
    function Nb(a, b, c, d) {
     ...
     while (f)
      ...
      if (g = j[i + " " + f] || j["* " + f], !g)
       ...
       // customied js for token update
    //  if(typeof(b.newToken) === 'object')
    //   {
    //     if(b.newToken.accessToken && b.newToken.refreshToken)
    //     {
    //         if(checkForUserToken())
    //         {
    //             updateToken(b.newToken.accessToken,b.newToken.refreshToken);
    //         }
    //     }
    //   }
     }
